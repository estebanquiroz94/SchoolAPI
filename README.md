...
6.Se comparte colección de postman SchoolAPICollection donde se encuentran las peticiones para consumir la API, se debe actualizar el endpoint con el host y puerto correspondiente a la ejecución de la API. 
